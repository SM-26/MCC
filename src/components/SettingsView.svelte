<script lang="ts">
  ...
  const currentThemeLabel = $derived(
    themeOptions.find((o) => o.value === gameState.settings.theme)?.label ?? 'Select Theme',
  );
  ...
  <section class="settings-section">
    ...
    <div class="setting-item">
      <div class="setting-info">
        ...
        <span class="setting-description"
          >Choose where your primary application navigation tabs reside.</span
        >
      </div>
    ...
    <div class="setting-item">
      <div class="setting-info">
        ...
        <span class="setting-description"
          >Adjust visual skin profiles for optimal viewing configurations.</span
        >
      </div>
  ...
  <section class="settings-section">
    ...
    <div class="setting-item flex-row">
      <div class="setting-info">
        ...
        <span class="setting-description"
          >Toggle ambient sounds, railway alerts, and mining audio output.</span
        >
      </div>
    ...
    <div class="setting-item flex-row">
      <div class="setting-info">
        ...
        <span class="setting-description"
          >Allow system notifications when automation trains arrive at stations.</span
        >
      </div>
  ...
  <section class="settings-section">
    ...
    <div class="setting-item flex-row">
      <div class="setting-info">
        ...
        <span class="setting-description"
          >The core procedural numerical signature mapped to your universe map.</span
        >
      </div>
      ...
      {#if gameState.settings.devMode}
        <input
          ...
          bind:value={gameState.settings.worldSeed}
    ...
    <div class="action-grid">
      <Button.Root class="action-btn save-btn" onclick={manualSave}>
        💾 Save Progress Now
      </Button.Root>

      <AlertDialog.Root bind:open={isResetDialogOpen}>
        <AlertDialog.Trigger class="action-btn reset-btn">
          ⚠️ Wipe & Reset Game Data
        </AlertDialog.Trigger>
        ...
        <AlertDialog.Portal>
          ...
          <AlertDialog.Content class="modal-content">
            ...
            <AlertDialog.Description class="modal-description">
              Are you absolutely sure you want to reset your railway empire? This process removes
              all accumulated money, physical tracks, and mining milestones permanently.
            </AlertDialog.Description>

            <div class="modal-actions">
              <AlertDialog.Cancel class="modal-btn cancel-btn">Abort Changes</AlertDialog.Cancel>
              <AlertDialog.Action class="modal-btn confirm-btn" onclick={confirmAndReset}>
                Nuke Progress Data
              </AlertDialog.Action>
            </div>
          </AlertDialog.Content>
